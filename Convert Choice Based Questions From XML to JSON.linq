...
void Main()
{
	...
	foreach(var c in choices)
	{
		...
		choice.Add(new XElement("title", c.Element("Title").Value));
		choice.Add(new XElement("score", c.Attribute("Score").Value));
		choice.Add(new XElement("correct", c.Attribute("Correct").Value));
